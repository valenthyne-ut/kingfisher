...
const SKIP_CREDENTIALS = args.find(value => value.startsWith("--skipCredentials")) !== undefined;
const SKIP_ENV_FILE = args.find(value => value.startsWith("--skipEnv")) !== undefined;
